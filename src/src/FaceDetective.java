...
/////////
     ...
     */
    public FaceDetective() {
        initComponents();
        System.out.println(FaceDetective.class.getResource("haarcascade_frontalface_alt.xml").getPath().substring(1));
    }
...
//                .addComponent(jPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FaceDetective.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FaceDetective().setVisible(true);
            }
        });
    }
